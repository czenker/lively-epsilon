        ...
        describe("filters", function()
            describe("by tags", function()
                it("filters by a single tag", function()
                    ...
                    local stationFrom = SpaceStation()
                    Station:withTags(stationFrom, "foo", "baz")
                    local stationTo = SpaceStation()
                    Station:withTags(stationTo, "bar", "baz")
                    local stationWithoutTags = SpaceStation()
                    local stationWithNoTags = SpaceStation()
                    Station:withTags(stationWithNoTags)
                    local stationWithDifferentTags = SpaceStation()
                ...
                it("filters by multiple tags", function()
                    ...
                    local stationWithOnlyOneTag = SpaceStation()
