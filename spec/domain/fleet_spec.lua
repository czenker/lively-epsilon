insulate("Fleet:new()", function()
    ...
    describe("row formation", function()
    ...
    describe("circle formation", function()
        it("lets them fly around the leader", function()
            local ship1 = CpuShip()
            local ship2 = CpuShip()
            local ship3 = CpuShip()
            local ship4 = CpuShip()
        ...
        it("keep position when a wingman is destroyed", function()
            local ship1 = CpuShip()
            local ship2 = CpuShip()
            local ship3 = CpuShip()
            local ship4 = CpuShip()
