insulate("Missions", function()
    ...
    describe("destroyRagingMiner()", function()
        it("should create a valid Mission with one ship", function()
            local mission = Missions:destroyRagingMiner(eeCpuShipMock())

            assert.is_true(Mission:isMission(mission))
        end)
        it("should create a valid Mission with one station", function()
            local mission = Missions:destroyRagingMiner(eeStationMock())

            assert.is_true(Mission:isMission(mission))
        end)
        it("should create a valid Mission with mixed space objects", function()
            local mission = Missions:destroyRagingMiner({eeCpuShipMock(), eeStationMock(), eeCpuShipMock()})
        ...
        it("fails if the first parameter is a table where one item is a person", function()
            assert.has_error(function() Missions:destroyRagingMiner({eeCpuShipMock(), eeStationMock(), personMock()}) end)
        end)
        ...
        it("should create a valid Mission if a callback function is given that returns one station", function()
            local mission = Missions:destroyRagingMiner(function() return eeStationMock() end)
            assert.is_true(Mission:isMission(mission))
            mission:setPlayer(player)
            mission:accept()
            mission:start()
        ...
        it("should create a valid Mission if a callback function is given that returns mixed space objects", function()
            local mission = Missions:destroyRagingMiner(function() return {eeCpuShipMock(), eeStationMock(), eeCpuShipMock()} end)
            assert.is_true(Mission:isMission(mission))
            mission:setPlayer(player)
            mission:accept()
            mission:start()
        ...
        it("fails if a call back function is given, but returns a table where one item is a person", function()
            assert.has_error(function()
                Missions:destroyRagingMiner(function() return {eeCpuShipMock(), eeStationMock(), personMock()} end)
                mission:setPlayer(player)
                mission:accept()
                mission:start()
            end)
        ...
        it("fails if second parameter is a number", function()
            assert.has_error(function() Missions:destroyRagingMiner(eeCpuShipMock(), 3) end)
        end)
    end)
